...
<head>
    ...
    <link href="assets/css/magnific-popup.css" rel="stylesheet">
 	...
 	<!-- Style CSS -->
 	<link href="assets/css/style.css?v=<?php echo filetime('assets/css/style.css');?>" rel="stylesheet">
 	<!-- Responsive CSS -->
 				...
 				<div class="col-lg-6 col-md-12 col-sm-12 text-end">
 					<div class="site-info">
 						...
 						<div class="social-area">
 							<a href="#"><i style="color:#ed3237"  class="lab la-facebook-f"></i></a>
 							<a href="#"><i style="color:#ed3237"  class="lab la-instagram"></i></a>
 							<a href="#"><i style="color:#ed3237"  class="lab la-twitter"></i></a>
 							<a href="#"><i style="color:#ed3237"  class="la la-skype"></i></a>
 						</div>
 					</div>
 				</div>
 			</div>
 				...
 				<div class="container">
 					<div class="row align-items-center">
 						<div class="col-lg-3">
 							...
 							<div class="logo">
 								<a class="navbar-brand" href="index.php"><img style="padding: 10px; width: 200px" src="assets/img/logo2.png" alt=""></a>
 							</div>
